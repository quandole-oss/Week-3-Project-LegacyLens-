"""Feature 5: Business Logic Extraction - Explain mathematical algorithms in routines."""

import json
from collections.abc import AsyncIterator
from backend.app.retrieval.search import CodeSearcher
from backend.app.retrieval.context import assemble_context
from backend.app.generation.llm import get_business_logic_chain
...
async def stream_business_logic(
    ...
    """Search for relevant code and extract business logic / mathematical algorithms."""
